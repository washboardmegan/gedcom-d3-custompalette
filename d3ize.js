...
// from https://gka.github.io/palettes/#/250|s||ffffe0,ff005e,93003a|1|1
const getColor = (p, surnameList) => {
  const colorList = 

['#ff3737', '#ff373b', '#ff373f', '#ff3743', '#ff3747', '#ff374b', '#ff374f', '#ff3753', '#ff3757', '#ff375b', '#ff375f', '#ff3763', '#ff3767', '#ff376b', '#ff376f', '#ff3773', '#ff3777', '#ff377b', '#ff377f', '#ff3783', '#ff3787', '#ff378a', '#ff378e', '#ff3792', '#ff3796', '#ff379a', '#ff379e', '#ff37a2', '#ff37a6', '#ff37aa', '#ff37ae', '#ff37b2', '#ff37b6', '#ff37ba', '#ff37be', '#ff37c2', '#ff37c6', '#ff37ca', '#ff37ce', '#ff37d2', '#ff37d6', '#ff37da', '#ff37de', '#ff37e2', '#ff37e6', '#ff37ea', '#ff37ee', '#ff37f2', '#ff37f6', '#ff37fa', '#fe37fd', '#fb37fd', '#f737fd', '#f336fd', '#ef36fd', '#ec36fd', '#e836fd', '#e436fd', '#e035fd', '#dd35fd', '#d935fd', '#d535fd', '#d135fd', '#ce34fc', '#ca34fc', '#c634fc', '#c234fc', '#bf34fc', '#bb33fc', '#b733fc', '#b433fc', '#b033fc', '#ac33fc', '#a832fc', '#a532fc', '#a132fc', '#9d32fc', '#9932fc', '#9631fc', '#9231fc', '#8e31fc', '#8a31fc', '#8731fc', '#8330fc', '#7f30fc', '#7c30fc', '#7830fc', '#7430fc', '#702ffb', '#6d2ffb', '#692ffb', '#652ffb', '#612ffb', '#5e2efb', '#5a2efb', '#562efb', '#522efb', '#4f2efb', '#4b2dfb', '#472dfb', '#452efb', '#4432fb', '#4435fb', '#4338fb', '#433cfb', '#423ffb', '#4242fb', '#4146fb', '#4149fb', '#404cfb', '#404ffb', '#4053fb', '#3f56fb', '#3f59fb', '#3e5dfb', '#3e60fb', '#3d63fb', '#3d67fb', '#3c6afb', '#3c6dfb', '#3b71fb', '#3b74fb', '#3a77fb', '#3a7bfb', '#397efb', '#3981fb', '#3884fb', '#3888fb', '#378bfb', '#378efb', '#3692fb', '#3695fb', '#3598fb', '#359cfb', '#349ffb', '#34a2fb', '#33a6fb', '#33a9fb', '#32acfb', '#32b0fb', '#32b3fb', '#31b6fb', '#31b9fb', '#30bdfb', '#30c0fb', '#2fc3fb', '#2fc7fb', '#2ecafb', '#2ecdfb', '#2dd1fb', '#2dd2fa', '#2dd3f8', '#2dd4f7', '#2dd5f5', '#2dd6f3', '#2dd7f1', '#2dd7f0', '#2dd8ee', '#2dd9ec', '#2ddaeb', '#2ddbe9', '#2ddce7', '#2ddce5', '#2ddde4', '#2ddee2', '#2ddfe0', '#2de0df', '#2de0dd', '#2de1db', '#2de2da', '#2de3d8', '#2de4d6', '#2de5d4', '#2de5d3', '#2de6d1', '#2de7cf', '#2de8ce', '#2de9cc', '#2deaca', '#2deac8', '#2debc7', '#2decc5', '#2dedc3', '#2deec2', '#2deec0', '#2defbe', '#2df0bd', '#2df1bb', '#2df2b9', '#2df3b7', '#2df3b6', '#2df4b4', '#2df5b2', '#2df6b1', '#2df7af', '#2df8ad', '#2df8ab', '#2df9aa', '#2dfaa8', '#2dfba6', '#2dfba6', '#2dfba6', '#2dfba6', '#2dfba6', '#2dfba6', '#2dfba6', '#2dfba6', '#2dfba6', '#2dfba6', '#2dfba6', '#2dfba6', '#2dfba6', '#2dfba6', '#2dfba6', '#2dfba6', '#2dfba6', '#2dfba6', '#2dfba6', '#2dfba6', '#2dfba6', '#2dfba6', '#2dfba6', '#2dfba6', '#2dfba6', '#2dfba6', '#2dfba6', '#2dfba6', '#2dfba6', '#2dfba6', '#2dfba6', '#2dfba6', '#2dfba6', '#2dfba6', '#2dfba6', '#2dfba6', '#2dfba6', '#2dfba6', '#2dfba6', '#2dfba6', '#2dfba6', '#2dfba6', '#2dfba6', '#2dfba6', '#2dfba6', '#2dfba6', '#2dfba6', '#2dfba6', '#2dfba6', '#2dfba6', '#2dfba6']
;
